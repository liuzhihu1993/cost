...
<body>
	...
	<form action="expa/financeAudit.do" method="post"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<p class="form-control-static">
							<fmt:formatDate value="${createTime}" type="both" />
						</p>
					</div>
				</div>
			</div>
		...
		<h5 class="page-header alert-info"
			style="margin: 0px; padding: 10px; margin-bottom: 10px">经理审核信息</h5>
		<div class="row">
			<div class="col-sm-7">
				<div class="form-group">
					<label class="col-sm-3 control-label">经理审核状态：</label>
					<div class="col-sm-9">
						<p class="form-control-static">${expa.managerMark==1?'通过':'' }</p>
					</div>
				</div>
			</div>
			<div class="col-sm-7">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<p class="form-control-static">${expa.managerName }</p>
					</div>
				</div>
			</div>
			<div class="col-sm-7">
		...
		<div class="row">
			<div class="col-sm-7">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<label> <input type="radio" name="financeMark" value="1" checked="checked" />通过
						</label> <label> <input type="radio" name="financeMark" value="0" />未通过
						</label> <label> <input type="radio" name="financeMark" value="2" />作废
						</label>
					</div>
				</div>
			</div>
			<div class="col-sm-7">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea rows="" class="form-control" name="financeDesc" cols=""></textarea>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-sm-10" align="center">
				<input type="submit" value="财务审核" class="btn btn-success" />
			</div>
		</div>
	</form>
